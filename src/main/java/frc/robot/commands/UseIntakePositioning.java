 ...
 */
public class UseIntakePositioning extends Command 
{
     ...
     */
    public UseIntakePositioning(IntakePositioning intakePositioning, IntakePosition intakePosition) 
    {
        this.intakePositioning = intakePositioning;
        this.intakePosition = intakePosition;
        
        // Use addRequirements() here to declare subsystem dependencies.
        if(this.intakePositioning != null)
        {
    ...
    public void execute()
    {
        ...
        {
            if(intakePosition == IntakePosition.kUp)
                intakePositioning.retract();
            else if(intakePosition == IntakePosition.kDown)
